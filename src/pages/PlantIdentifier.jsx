...
const plants = [
    {
        ...
        items: [
            ...
            { name: "Snake Plant", image: "/.com/image_upload/Gemini_Generated_Image_hsua2shsua2shsua.png", description: "Hardy and low-light tolerant." },
            { name: "Fiddle Leaf Fig", image: "/.com/image_upload/fiddle_leaf_fig.png", description: "Popular for its large, violin-shaped leaves." },
            { name: "Pothos", image: "/.com/image_upload/pothos.png", description: "Fast-growing trailing vine." }
        ]
    },
    {
    ...
    },
    {
        ...
        items: [
            { name: "Leaf Spot", image: "/.com/image_upload/shot_hole_disease.png", description: "Brown or black spots on foliage." },
            { name: "Powdery Mildew", image: "/.com/image_upload/powdery_mildew.png", description: "White fungal growth on leaves." },
